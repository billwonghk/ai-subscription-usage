...
TEXT = {
    ...
    "zh-TW": {**EN, "title": "AI 訂閱用量：設定", "language": "語言", "autostart": "登入時自動啟動", "telemetry": "傳送匿名診斷", "refresh_interval": "自動更新", "refresh_schedule": "依本機時間每天凌晨 3:00 更新一次。當天未成功更新時，應用程式啟動 15 分鐘後補更新一次；當天已經更新則略過。", "open_data_folder": "開啟資料夾", "clear_diagnostics": "清除診斷記錄", "diagnostics_cleared": "診斷記錄已清除", "report_issue": "回報問題", "hours_suffix": "小時", "on": "已開啟", "off": "已關閉", "app_not_running": "本機應用程式未執行", "providers": "監控平台", "providers_note": "選擇需要統計的平台。只有已新增的平台會被讀取、計算並顯示在報表中。", "add": "新增", "remove": "移除", "copy_prompt": "複製設定提示詞", "prompt_copied": "設定提示詞已複製", "prompt_copy_failed": "無法自動複製，請手動複製設定提示詞。", "provider_updating": "正在儲存平台選擇並更新報表…", "provider_added": "{provider} 已新增，報表正在更新。", "provider_removed": "{provider} 已移除，報表正在更新。", "ready": "已找到本機記錄", "ready_enabled": "已新增 · 本機記錄將納入統計", "ready_available": "已找到本機記錄 · 新增後才會納入統計", "no_records": "找不到本機記錄", "not_found": "找不到應用程式或資料目錄", "permission_required": "需要讀取權限", "unsupported_format": "已偵測到記錄，等待格式驗證", "enabled": "已新增", "available": "可新增平台", "plans": "訂閱方案管理", "plans_note": "填寫錯誤的訂閱方案只能在此刪除，報表卡片不提供刪除入口。", "no_plans": "尚未儲存訂閱方案", "delete_plan": "刪除", "delete_confirm": "確認刪除這筆訂閱方案嗎？只會刪除目前平台與生效日期對應的記錄。", "plan_deleting": "正在刪除指定方案並更新報表…", "month": "月", "year": "年"},
...
TEXT["ja"].update({"enabled": "追加済み", "available": "追加できるプラットフォーム", "refresh_schedule": "現地時刻の毎日午前3時に1回更新します。更新できなかった日は、次回起動の15分後に補完し、当日すでに成功していれば省略します。", "prompt_copy_failed": "自動コピーに失敗しました。設定プロンプトを手動でコピーしてください。", "provider_updating": "プラットフォームの選択を保存し、レポートを更新しています…", "provider_added": "{provider}を追加しました。レポートを更新しています。", "provider_removed": "{provider}を削除しました。レポートを更新しています。", "ready_enabled": "追加済み・ローカル記録を集計します", "ready_available": "ローカル記録を検出・追加後に集計します", "plans": "サブスクリプションプラン管理", "plans_note": "誤って入力したプランはここで削除します。レポートカードには削除操作がありません。", "no_plans": "保存済みプランはありません", "delete_plan": "削除", "delete_confirm": "このサブスクリプションプランを削除しますか？選択したプロバイダーと適用開始日の記録だけが削除されます。", "plan_deleting": "選択したプランを削除し、レポートを更新しています…", "month": "月", "year": "年"})
TEXT["ko"].update({"enabled": "추가됨", "available": "추가 가능한 플랫폼", "refresh_schedule": "현지 시간 기준 매일 오전 3시에 한 번 업데이트합니다. 당일 업데이트를 놓치면 다음 실행 15분 후 보완하며, 당일 이미 성공했다면 건너뜁니다.", "prompt_copy_failed": "자동 복사에 실패했습니다. 설정 프롬프트를 직접 복사하세요.", "provider_updating": "플랫폼 선택을 저장하고 보고서를 업데이트하는 중…", "provider_added": "{provider} 추가됨. 보고서를 업데이트하는 중입니다.", "provider_removed": "{provider} 제거됨. 보고서를 업데이트하는 중입니다.", "ready_enabled": "추가됨 · 로컬 기록이 집계됩니다", "ready_available": "로컬 기록 발견 · 추가한 뒤 집계됩니다", "plans": "구독 플랜 관리", "plans_note": "잘못 입력한 플랜은 여기에서 삭제합니다. 보고서 카드에는 삭제 기능이 없습니다.", "no_plans": "저장된 구독 플랜 없음", "delete_plan": "삭제", "delete_confirm": "이 구독 플랜을 삭제할까요? 선택한 공급자와 적용 시작일의 기록만 삭제됩니다.", "plan_deleting": "선택한 플랜을 삭제하고 보고서를 업데이트하는 중…", "month": "월", "year": "년"})
TEXT["fr"].update({"enabled": "Ajoutée", "available": "Plateformes disponibles", "refresh_schedule": "Actualisation une fois par jour à 03:00, heure locale. Si elle est manquée, elle a lieu 15 minutes après le prochain lancement, sauf si elle a déjà réussi ce jour-là.", "prompt_copy_failed": "La copie automatique a échoué. Copiez l’invite de configuration manuellement.", "provider_updating": "Enregistrement de la sélection et actualisation du rapport…", "provider_added": "{provider} ajoutée. Le rapport est en cours d’actualisation.", "provider_removed": "{provider} retirée. Le rapport est en cours d’actualisation.", "ready_enabled": "Ajoutée · les données locales seront comptabilisées", "ready_available": "Données locales trouvées · ajoutez la plateforme pour les comptabiliser", "plans": "Gestion des abonnements", "plans_note": "Supprimez ici un abonnement erroné. Les cartes du rapport ne contiennent aucune commande de suppression.", "no_plans": "Aucun abonnement enregistré", "delete_plan": "Supprimer", "delete_confirm": "Supprimer cet abonnement ? Seul l’enregistrement du fournisseur et de la date d’effet sélectionnés sera supprimé.", "plan_deleting": "Suppression de l’abonnement sélectionné et actualisation du rapport…", "month": "mois", "year": "an"})
TEXT["de"].update({"enabled": "Hinzugefügt", "available": "Verfügbare Plattformen", "refresh_schedule": "Einmal täglich um 03:00 Uhr Ortszeit. Wurde die Aktualisierung verpasst, erfolgt sie 15 Minuten nach dem nächsten Start, sofern sie an diesem Tag noch nicht erfolgreich war.", "prompt_copy_failed": "Automatisches Kopieren fehlgeschlagen. Kopieren Sie den Einrichtungs-Prompt manuell.", "provider_updating": "Plattformauswahl wird gespeichert und der Bericht aktualisiert…", "provider_added": "{provider} wurde hinzugefügt. Der Bericht wird aktualisiert.", "provider_removed": "{provider} wurde entfernt. Der Bericht wird aktualisiert.", "ready_enabled": "Hinzugefügt · lokale Daten werden einbezogen", "ready_available": "Lokale Daten gefunden · nach dem Hinzufügen werden sie einbezogen", "plans": "Abonnementverwaltung", "plans_note": "Löschen Sie hier einen fehlerhaften Plan. Berichtskarten enthalten keine Löschfunktion.", "no_plans": "Keine Abonnements gespeichert", "delete_plan": "Löschen", "delete_confirm": "Dieses Abonnement löschen? Nur der Eintrag für den gewählten Anbieter und das Wirksamkeitsdatum wird gelöscht.", "plan_deleting": "Gewähltes Abonnement wird gelöscht und der Bericht aktualisiert…", "month": "Monat", "year": "Jahr"})
TEXT["es"].update({"enabled": "Añadida", "available": "Plataformas disponibles", "refresh_schedule": "Se actualiza una vez al día a las 03:00, hora local. Si se omite, se actualiza 15 minutos después del siguiente inicio, salvo que ya se haya completado ese día.", "prompt_copy_failed": "No se pudo copiar automáticamente. Copia manualmente la instrucción de configuración.", "provider_updating": "Guardando la selección de plataformas y actualizando el informe…", "provider_added": "{provider} añadida. El informe se está actualizando.", "provider_removed": "{provider} eliminada. El informe se está actualizando.", "ready_enabled": "Añadida · se incluirán los registros locales", "ready_available": "Registros locales encontrados · se incluirán después de añadirla", "plans": "Gestión de planes de suscripción", "plans_note": "Elimina aquí un plan incorrecto. Las tarjetas del informe no incluyen controles de eliminación.", "no_plans": "No hay planes guardados", "delete_plan": "Eliminar", "delete_confirm": "¿Eliminar este plan de suscripción? Solo se eliminará el registro del proveedor y la fecha de vigencia seleccionados.", "plan_deleting": "Eliminando el plan seleccionado y actualizando el informe…", "month": "mes", "year": "año"})
TEXT["zh-CN"].update({
...
LANGUAGE_NAMES = {"en": "English", "zh-CN": "简体中文", "zh-TW": "繁體中文", "ja": "日本語", "ko": "한국어", "fr": "Français", "de": "Deutsch", "es": "Español"}
...
def render_settings(language: str, current_settings: dict, autostart_enabled: bool, autostart_supported: bool, app_version: str = "development", provider_states: list[dict] | None = None, setup_prompt: str = "", subscription_plans: list[dict] | None = None) -> str:
    ...
    def provider_label(value: str) -> str:
        if value == "阿里百炼":
            return {"en": "Alibaba Bailian", "zh-TW": "阿里百鍊"}.get(language, value)
        return value
